...
public class RecyclerViewAdapterEndomorphDay1 extends RecyclerView.Adapter<RecyclerViewAdapterEndomorphDay1.MyViewHolder> {
    Context context;
    List<Gym> list;

    public RecyclerViewAdapterEndomorphDay1(Context context, List<Gym> list) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterEndomorphDay1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_view_item,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterEndomorphDay1.MyViewHolder holder, int position) {
