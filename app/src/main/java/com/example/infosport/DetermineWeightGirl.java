...
public class DetermineWeightGirl extends AppCompatActivity {

    public int resultWeight; //переменная для подсчёта процента жира в организме
    public Double obD,weight1,height; //переменная для подсчёта процента жира в организме
    ...
    public Double weight, weightresult; // переменные для подсчёта иедеального веса
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_determine_weight_girl);
        ...
        textViewWeight = findViewById(R.id.textView950);
        ...
        createDialogMassGirl(); //Процент жира в организме
    ...
    private void createDialogMassGirl() {

        View view = getLayoutInflater().inflate(R.layout.button_dialog_weight_girl,null,false);
        ...
        startP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!ob.getText().toString().equals("") && (!mass.getText().toString().equals("") && (!h.getText().toString().equals("")))) {
                    ...
                    resultWeight = (int) ((0.11077 * obD) - (0.17666 * height) + (0.14354 * weight1) + 51.033);

                    AlertDialog.Builder alert = new AlertDialog.Builder(DetermineWeightGirl.this);
                    alert.setTitle(R.string.result);
                    alert.setMessage(R.string.gir + resultWeight + "%");
                    alert.setPositiveButton(R.string.close, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if (resultWeight <= 10) {
                                Toast.makeText(DetermineWeightGirl.this, R.string.nise, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(DetermineWeightGirl.this, R.string.vrema, Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                ...
                if (!ageP.getText().toString().equals("")) {
                    ...
                    alert.setPositiveButton(R.string.close, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Toast.makeText(DetermineWeightGirl.this, R.string.nice, Toast.LENGTH_SHORT).show();
                        }
                    });
                    alert.create().show();
                    dialog4.dismiss();
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!weightC.getText().toString().equals("") && !heightC.getText().toString().equals("") && !ageC.getText().toString().equals("")) {
                    ...
                    resultCalories = (10 * weightCalories) + (6.25 * heightCalories) - (5 * ageCalories) - 161;
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!growthNumberWeight.getText().toString().equals("") && !growthNumberTime.getText().toString().equals("")) {
                    ...
                    resultWater = (int) ((weightWater * 0.03) + (timeWater * 0.4));
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!growthNumber.getText().toString().equals("")) {
                    ...
                    weightresult = ((3.5 * weight / 2.54 - 108) * 0.453);
                    AlertDialog.Builder alert = new AlertDialog.Builder(DetermineWeightGirl.this);
